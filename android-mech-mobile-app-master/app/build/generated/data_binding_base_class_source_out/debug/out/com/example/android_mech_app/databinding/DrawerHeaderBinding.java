...
public final class DrawerHeaderBinding implements ViewBinding {
  ...
  private DrawerHeaderBinding(@NonNull LinearLayout rootView, @NonNull TextView loggedUsername) {
  ...
  public static DrawerHeaderBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.loggedUsername;
      TextView loggedUsername = ViewBindings.findChildViewById(rootView, id);
      if (loggedUsername == null) {
        break missingId;
      }

      return new DrawerHeaderBinding((LinearLayout) rootView, loggedUsername);
    }
